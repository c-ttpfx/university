<template>
  <el-dialog
    ...
    <el-form-item label="商品 id" prop="spuId">
      <el-input v-model="dataForm.spuId" placeholder="商品 id"></el-input>
    </el-form-item>
    <el-form-item label="属性 id" prop="attrId">
      <el-input v-model="dataForm.attrId" placeholder="属性 id"></el-input>
    </el-form-item>
...
" prop="quickShow">
      <el-input v-model="dataForm.quickShow" placeholder="快速展示【是否展示在介绍上；0-否 1-是】
"></el-input>
    </el-form-item>
    </el-form>
  ...
  export default {
    data () {
      return {
        ...
        dataRule: {
          spuId: [
            { required: true, message: '商品 id不能为空', trigger: 'blur' }
          ],
          attrId: [
            { required: true, message: '属性 id不能为空', trigger: 'blur' }
          ],
          attrName: [
          ...
          quickShow: [
            { required: true, message: '快速展示【是否展示在介绍上；0-否 1-是】
不能为空', trigger: 'blur' }
          ]
        }
      }
