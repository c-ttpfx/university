<template>
  <el-dialog
    ...
    <el-form-item label="属性分组 id" prop="attrGroupId">
      <el-input v-model="dataForm.attrGroupId" placeholder="属性分组 id"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          attrGroupId: [
            { required: true, message: '属性分组 id不能为空', trigger: 'blur' }
          ],
          attrSort: [
